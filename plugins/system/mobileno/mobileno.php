<?php
/**
 * @version		$Id: mobileno.php 20196 2011-03-04 02:40:25Z mrichey $
 * @package		plg_auth_mobileno
...
class plgSystemMobileno extends JPlugin
{
	function onAfterRoute()
	{
            ...
            if(count($jform) && preg_match('/@/',$jform['username'])) {
                ...
                $query->select('username')->from('#__users')->where('mobileno = '.$db->quote($jform['username']));
                $db->setQuery($query);
